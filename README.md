...
- 취약점은 공개 Issue 대신 GitHub의 비공개 보안 권고로 제보해 주세요.

자세한 제보 절차는 [SECURITY.md](./SECURITY.md)를 참고해 주세요.
...
버그 제보에는 재현 경로, 기대 동작, 실제 동작과 실행 환경을 포함해 주세요. 보안 문제는 반드시 [보안 정책](./SECURITY.md)을 따라 비공개로 제보해 주세요.
